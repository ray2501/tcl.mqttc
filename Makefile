...
PKG_SOURCES	=  tclmqttc.c MQTTProtocolClient.c Clients.c utf-8.c StackTrace.c MQTTPacket.c MQTTPacketOut.c Messages.c Tree.c Socket.c Log.c MQTTPersistence.c Thread.c MQTTProtocolOut.c MQTTPersistenceDefault.c SocketBuffer.c Heap.c LinkedList.c MQTTClient.c SSLSocket.c
PKG_OBJECTS	=  tclmqttc.o MQTTProtocolClient.o Clients.o utf-8.o StackTrace.o MQTTPacket.o MQTTPacketOut.o Messages.o Tree.o Socket.o Log.o MQTTPersistence.o Thread.o MQTTProtocolOut.o MQTTPersistenceDefault.o SocketBuffer.o Heap.o LinkedList.o MQTTClient.o SSLSocket.o
...
PKG_LIB_FILE	= libmqttc0.2.so
PKG_STUB_LIB_FILE = libmqttcstub0.2.a
