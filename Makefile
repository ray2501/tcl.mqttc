...
PKG_SOURCES	=  tclmqttc.c Base64.c MQTTProperties.c MQTTReasonCodes.c SHA1.c WebSocket.c MQTTProtocolClient.c Clients.c utf-8.c StackTrace.c MQTTPacket.c MQTTPacketOut.c Messages.c Tree.c Socket.c Log.c MQTTPersistence.c Thread.c MQTTProtocolOut.c MQTTPersistenceDefault.c MQTTTime.c SocketBuffer.c Heap.c LinkedList.c MQTTClient.c SSLSocket.c OsWrapper.c
...
PKG_LIB_FILE	= libmqttc0.10.so
PKG_STUB_LIB_FILE = libmqttcstub0.10.a
