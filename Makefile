...
PKG_LIB_FILE	= libmqttc0.18.so
PKG_LIB_FILE8	= libmqttc0.18.so
PKG_LIB_FILE9	= libtcl9mqttc0.18.so
PKG_STUB_LIB_FILE = libmqttcstub0.18.a
...
top_builddir	= /home/danilo/Public/tcl.mqttc
...
PKG_CFLAGS	=  -DUNIXSOCK=1 -DOPENSSL -DTLS2_VERSION -DTLS3_VERSION
