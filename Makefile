...
PKG_SOURCES	=  tclmqttc.c Base64.c MQTTProperties.c MQTTReasonCodes.c SHA1.c WebSocket.c MQTTProtocolClient.c Clients.c utf-8.c StackTrace.c MQTTPacket.c MQTTPacketOut.c Messages.c Tree.c Socket.c Log.c Proxy.c MQTTPersistence.c Thread.c MQTTProtocolOut.c MQTTPersistenceDefault.c MQTTTime.c SocketBuffer.c Heap.c LinkedList.c MQTTClient.c SSLSocket.c OsWrapper.c
PKG_OBJECTS	=  tclmqttc.o Base64.o MQTTProperties.o MQTTReasonCodes.o SHA1.o WebSocket.o MQTTProtocolClient.o Clients.o utf-8.o StackTrace.o MQTTPacket.o MQTTPacketOut.o Messages.o Tree.o Socket.o Log.o Proxy.o MQTTPersistence.o Thread.o MQTTProtocolOut.o MQTTPersistenceDefault.o MQTTTime.o SocketBuffer.o Heap.o LinkedList.o MQTTClient.o SSLSocket.o OsWrapper.o
...
PKG_LIB_FILE	= libmqttc0.15.so
PKG_STUB_LIB_FILE = libmqttcstub0.15.a
...
PKG_CFLAGS	=   -DOPENSSL -DTLS2_VERSION -DTLS3_VERSION
...
# compiled with.
#DEFS		= $(TCL_DEFS) -DPACKAGE_NAME=\"mqttc\" -DPACKAGE_TARNAME=\"mqttc\" -DPACKAGE_VERSION=\"0.15\" -DPACKAGE_STRING=\"mqttc\ 0.15\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\" -DBUILD_mqttc=/\*\*/ -DHAVE_STDIO_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_STRINGS_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_UNISTD_H=1 -DSTDC_HEADERS=1 -DHAVE_LIMITS_H=1 -DHAVE_SYS_PARAM_H=1 -DUSE_THREAD_ALLOC=1 -D_REENTRANT=1 -D_THREAD_SAFE=1 -DTCL_THREADS=1 -DUSE_TCL_STUBS=1 -DUSE_TCLOO_STUBS=1 -DMODULE_SCOPE=extern\ __attribute__\(\(__visibility__\(\"hidden\"\)\)\) -DHAVE_HIDDEN=1 -DHAVE_CAST_TO_UNION=1 -D_LARGEFILE64_SOURCE=1 -DTCL_WIDE_INT_IS_LONG=1 $(PKG_CFLAGS)
DEFS		= -DPACKAGE_NAME=\"mqttc\" -DPACKAGE_TARNAME=\"mqttc\" -DPACKAGE_VERSION=\"0.15\" -DPACKAGE_STRING=\"mqttc\ 0.15\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\" -DBUILD_mqttc=/\*\*/ -DHAVE_STDIO_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_STRINGS_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_UNISTD_H=1 -DSTDC_HEADERS=1 -DHAVE_LIMITS_H=1 -DHAVE_SYS_PARAM_H=1 -DUSE_THREAD_ALLOC=1 -D_REENTRANT=1 -D_THREAD_SAFE=1 -DTCL_THREADS=1 -DUSE_TCL_STUBS=1 -DUSE_TCLOO_STUBS=1 -DMODULE_SCOPE=extern\ __attribute__\(\(__visibility__\(\"hidden\"\)\)\) -DHAVE_HIDDEN=1 -DHAVE_CAST_TO_UNION=1 -D_LARGEFILE64_SOURCE=1 -DTCL_WIDE_INT_IS_LONG=1 $(PKG_CFLAGS)
